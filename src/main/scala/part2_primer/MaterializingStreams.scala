...
/*  val source = Source(1 to 10)
  ...
  // simpleSource.viaMat(simpleFlow)((_sourceMat, flowMat) => flowMat)
  // simpleSource.viaMat(simpleFlow)(Keep.right) // Keep.left/both/none
   ...
   * - compute the total word cont of a stream of sentences
   *   - map, fold, reduce
   */
